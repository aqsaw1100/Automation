...
cy.get(locators.textbox).click()
cy.get(locators.properties).click()//click on properties
cy.get(locators.labeltextt).should('be.visible').clear().type('colour')//label
...
cy.get(locators.placeholder).should('be.visible').clear().type('yourchoicecolor')
