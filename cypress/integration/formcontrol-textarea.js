...
cy.get(locators.textarea).click()
cy.get(locators.properties).click()//click on properties
cy.get(locators.labeltextt).should('be.visible').clear().type('anycomments')//label
...
cy.get(locators.placeholder).should('be.visible').clear().type('writedownsuggestions')
